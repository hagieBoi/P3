...
public int overallScore()
{
   ...
   if (score1 < score2 && score1 < score3) {
      ...
      //score 2 would be min val, s2 should be set to score 3   
      s1 = score1;
      s2 = score2;
      ...
      //if the all scores are equal will end up with invalid final score.
      s1 = 99;
      s2 = 99;
   }
   s = s1 + s2;
...
public static void main(String args[])
{
   ...
   //scores are inclusive not exclusive
